...
class MultibandGenerator(Generator):
    def __init__(self, input_channel=80, output_channel=4, hu=384, ku=[8, 8, 2, 2], kr=[3, 7, 11], Dr=[1, 3, 5]):
        super(MultibandGenerator, self).__init__(input_channel=input_channel, output_channel= output_channel, hu=hu,
                                                 ku=ku, kr=kr, Dr =Dr)
